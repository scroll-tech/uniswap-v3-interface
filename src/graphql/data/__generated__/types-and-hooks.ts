...
export type BlockaidFees = {
  readonly __typename?: 'BlockaidFees';
  readonly buy?: Maybe<Scalars['Float']>;
  readonly sell?: Maybe<Scalars['Float']>;
  readonly transfer?: Maybe<Scalars['Float']>;
};
...
export type PortfolioValueModifier = {
  ...
  readonly ownerAddress: Scalars['String'];
  readonly tokenBalancesLimit?: InputMaybe<Scalars['Int']>;
...
export type ProtectionInfo = {
  readonly __typename?: 'ProtectionInfo';
  readonly attackTypes?: Maybe<ReadonlyArray<Maybe<ProtectionAttackType>>>;
  readonly blockaidFees?: Maybe<BlockaidFees>;
  readonly result?: Maybe<ProtectionResult>;
};
...
export type Query = {
  ...
  readonly topV4Pools?: Maybe<ReadonlyArray<V4Pool>>;
  ...
  readonly v4Pool?: Maybe<V4Pool>;
  readonly v4PoolsForTokenPair?: Maybe<ReadonlyArray<V4Pool>>;
  readonly v4Transactions?: Maybe<ReadonlyArray<PoolTransaction>>;
};
...
export type QueryPortfoliosArgs = {
  chains?: InputMaybe<ReadonlyArray<Chain>>;
  fungibleIds?: InputMaybe<ReadonlyArray<Scalars['String']>>;
...
export type Token = IContract & {
  ...
  readonly protectionInfo?: Maybe<ProtectionInfo>;
  readonly standard?: Maybe<TokenStandard>;
  readonly symbol?: Maybe<Scalars['String']>;
  readonly v2Transactions?: Maybe<ReadonlyArray<Maybe<PoolTransaction>>>;
  readonly v3Transactions?: Maybe<ReadonlyArray<Maybe<PoolTransaction>>>;
  readonly v4Transactions?: Maybe<ReadonlyArray<Maybe<PoolTransaction>>>;
};
...
export type V4Pool = {
  readonly __typename?: 'V4Pool';
  readonly chain: Chain;
  readonly createdAtTimestamp?: Maybe<Scalars['Int']>;
  readonly cumulativeVolume?: Maybe<Amount>;
  readonly feeTier?: Maybe<Scalars['Float']>;
  readonly historicalVolume?: Maybe<ReadonlyArray<Maybe<TimestampedAmount>>>;
  readonly hook?: Maybe<V4PoolHook>;
  readonly id: Scalars['ID'];
  readonly poolId: Scalars['String'];
  readonly priceHistory?: Maybe<ReadonlyArray<Maybe<TimestampedPoolPrice>>>;
  readonly protocolVersion: ProtocolVersion;
  readonly ticks?: Maybe<ReadonlyArray<Maybe<V4PoolTick>>>;
  readonly token0?: Maybe<Token>;
  readonly token0Supply?: Maybe<Scalars['Float']>;
  readonly token1?: Maybe<Token>;
  readonly token1Supply?: Maybe<Scalars['Float']>;
...
export type V4PoolHook = {
  readonly __typename?: 'V4PoolHook';
  readonly address: Scalars['String'];
  readonly id: Scalars['ID'];
};

export type V4PoolTick = {
  readonly __typename?: 'V4PoolTick';
  readonly id: Scalars['ID'];
  readonly liquidityGross?: Maybe<Scalars['String']>;
  readonly liquidityNet?: Maybe<Scalars['String']>;
  readonly price0?: Maybe<Scalars['String']>;
...
export type ConvertQuery = { readonly __typename?: 'Query', readonly convert?: { readonly __typename?: 'Amount', readonly id: string, readonly value: number, readonly currency?: Currency } };
...
export type TopV3PoolsQuery = { readonly __typename?: 'Query', readonly topV3Pools?: ReadonlyArray<{ readonly __typename?: 'V3Pool', readonly id: string, readonly protocolVersion: ProtocolVersion, readonly address: string, readonly feeTier?: number, readonly totalLiquidity?: { readonly __typename?: 'Amount', readonly value: number }, readonly token0?: { readonly __typename?: 'Token', readonly name?: string, readonly symbol?: string, readonly address?: string, readonly chain: Chain }, readonly token1?: { readonly __typename?: 'Token', readonly name?: string, readonly symbol?: string, readonly address?: string, readonly chain: Chain }, readonly volume24h?: { readonly __typename?: 'Amount', readonly value: number }, readonly volume30d?: { readonly __typename?: 'Amount', readonly value: number } }> };
